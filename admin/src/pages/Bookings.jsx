...
const Bookings = () => {
    ...
    return (
        <div className='h-screen p-8'>
            < p className=' ml-10 mt-5 mb-8 font-semibold text-4xl' >Bookings</ p>
            <p className=' ml-10 mt-5 mb-3 font-bold text-2xl'>Upcoming Bookings !</p>
            <div className='flex flex-wrap justify-start gap-5'>
                ...
                {upcomingBookings.length === 0 &&
                    <p className='ml-10 mt-5 mb-16 font-bold text-xl'> You don't have any upcoming bookings.</p>}
            </div>
            <p className=' ml-10 mt-5 mb-3 font-bold text-2xl'>Previous Bookings !</p>
            <div className='flex flex-wrap justify-start gap-5'>
                ...
                {previousBookings.length === 0 &&
                    <p className='ml-10 mt-5 mb-5 font-bold text-xl'>You don't have any previous bookings. </p>}
            </div>
        </div >
    )
}
