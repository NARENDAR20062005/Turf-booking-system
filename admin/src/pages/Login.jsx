...
const Login = () => {
    ...
    return (
        <div className="flex h-screen ">
            ...
            <div className="lg:flex-1 bg-green-700  flex h-screen text-white p-12  flex items-center justify-center">
                <div>
                    <h2 className="text-4xl text-black font-bold text-center mb-4">Welcome to Book-Turf (Admin panel)</h2>
                    <p className="text-lg  text-center ">Login to access your account !</p>
                </div>
            </div>

            {/* Right side with login form */}
            <div className="lg:flex-1 flex bg-gray-100 items-center justify-center p-12">
