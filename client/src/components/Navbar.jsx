		...
		<nav className="bg-gray-900 p-4">
			<div className="container mx-auto">
				<div className="flex justify-between items-center">
					<div className="text-white font-bold text-xl cursor-pointer" onClick={() => { navigate('/') }}>Book-Turf</div>
					...
					<div className="lg:flex items-center justify-between text-lg gap-4">
						{isLogin && <>
							...
							<p className="text-white font-medium cursor-pointer hidden lg:block" onClick={() => { navigate('/grounds') }}>Turfs</p>
							<p className="text-white font-medium cursor-pointer hidden lg:block" onClick={() => { navigate('/bookings') }}>Your-Bookings</p>
						</>}
							...
							<div className="mx-auto flex items-center justify-center bg-none rounded-md">
								<div className="group relative cursor-pointer">
									<div className="flex items-center justify-between space-x-5 bg-none px-2 rounded-sm">
										<a className="menu-hover py-2 text-base font-medium text-white lg:mx-4" >
											Hi, {user}!
										</a>
										<span>
