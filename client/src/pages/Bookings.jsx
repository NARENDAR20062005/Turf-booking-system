...
const Bookings = () => {
  ...
  const { upcomingBookings, previousBookings } = useSelector((state) => state.bookings);
    ...
    const getBookings = async () => {
      try {
        ...
        if (data.success) {
          ...
          dispatch(setBookings({ upcoming, previous }));
        }
      } catch (error) {
        console.log(error);
      }
...
//                             date={booking?.date.slice(0, 10)}
//                             time={booking?.timeSlot}
//                             handleDeleteBooking={handleDeleteBooking} // Pass the delete function
//                         />
//                     </div>
//                 )}
//                 {upcomingBookings.length === 0 &&
