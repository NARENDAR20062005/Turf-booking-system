...
const Login = () => {
	...
	return (
		<div className="flex flex-col lg:flex-row lg:h-screen">
			...
			<div className="lg:flex-1 bg-gray-500 text-white p-12 flex items-center justify-center">
				<div>
					<h2 className="text-4xl font-bold mb-4 text-center text-black lg:text-left">Welcome to Book-Turf.com </h2>
					<p className="text-lg  text-center ml-50 lg:text-left">Login to access your account.</p>
				</div>
			</div>
			...
			<div className="lg:flex-1 flex items-center justify-center p-12">
				<form className="max-w-md w-full space-y-4">
					...
					{authState === "signup" && (
						<div>
							<label className="block text-bold text-gray-700">Username</label>
							<input
								type="text"
								name="username"
					...
					<div>
						<label className="block text-bold text-gray-700">Email</label>
						<input
							type="email"
							name="email"
							className="w-full border border-gray-300 rounded px-4 py-2"
